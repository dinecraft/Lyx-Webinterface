<?php
namespace App\Plugins\Native\PermissonsPlugin;
use App\Plugins\Native\PermissionsPlugin\Main\Internal\router;
...
class handler
{
    ...
    {
        //die route wird als string gegettet, von /user/flow/ oder /user/send/
